  ...
  factory: function (require) {
    ...
    var I18N = {
      zh: {
        ...
        protection: "文字轮廓", protectionOff: "关闭", protectionBalanced: "均衡", protectionStrong: "增强",
        readabilityNote: "不增加背景框；遮罩跟随主题明暗，文字轮廓作用于正文、思考、工具调用和输入提示。",
      ...
      en: {
        ...
        protection: "Text outline", protectionOff: "Off", protectionBalanced: "Balanced", protectionStrong: "Strong",
        readabilityNote: "No backing boxes: the overlay follows the theme, while the outline covers messages, reasoning, tool calls and input hints.",
