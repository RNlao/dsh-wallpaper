  ...
  factory: function (require) {
    ...
    var I18N = {
      zh: {
        ...
        trajectoryColorScheme: "轨迹配色方案", nativeScheme: "DSH 原生", lightScheme: "深色文字（浅色壁纸）", darkScheme: "浅色文字（深色壁纸）",
        readabilityNote: "文字颜色应用于主界面的标题栏、输入栏、思考和工具调用；轨迹页使用独立配色方案。",
        trajectorySchemeNote: "配色方案只调整轨迹文字、图标、状态色、边框和小型浮层；业务状态色仍保留区分。",
      ...
      en: {
        ...
        trajectoryColorScheme: "Trajectory color scheme", nativeScheme: "DSH native", lightScheme: "Dark text (light wallpaper)", darkScheme: "Light text (dark wallpaper)",
        readabilityNote: "Text color applies to the Main UI header, composer, thinking and tool calls; Trajectory uses its own color scheme.",
        trajectorySchemeNote: "Schemes change Trajectory text, icons, status colors, borders and small popovers only; semantic status colors remain distinct.",
    ...
    var UI_CSS = [
      ...
      "body:not([data-ds-dark-theme]) .dshwp-root{color:#0f1115!important;}body:not([data-ds-dark-theme]) .dshwp-root .dshwp-title,body:not([data-ds-dark-theme]) .dshwp-root .dshwp-btn:not(.dshwp-btn-primary),body:not([data-ds-dark-theme]) .dshwp-root .dshwp-file-name{color:#0f1115!important;-webkit-text-fill-color:#0f1115!important;}body:not([data-ds-dark-theme]) .dshwp-root .dshwp-toolbar-label,body:not([data-ds-dark-theme]) .dshwp-root .dshwp-toggle,body:not([data-ds-dark-theme]) .dshwp-root .dshwp-row label,body:not([data-ds-dark-theme]) .dshwp-root .dshwp-val,body:not([data-ds-dark-theme]) .dshwp-root .dshwp-note,body:not([data-ds-dark-theme]) .dshwp-root .dshwp-file-size,body:not([data-ds-dark-theme]) .dshwp-root .dshwp-preview,body:not([data-ds-dark-theme]) .dshwp-root .dshwp-file-thumb-empty{color:#374151!important;-webkit-text-fill-color:#374151!important;}body:not([data-ds-dark-theme]) .dshwp-root .dshwp-color-code{color:#0f1115!important;-webkit-text-fill-color:#0f1115!important;}body[data-ds-dark-theme] .dshwp-root{color:#f1f5f9!important;}body[data-ds-dark-theme] .dshwp-root .dshwp-title,body[data-ds-dark-theme] .dshwp-root .dshwp-btn:not(.dshwp-btn-primary),body[data-ds-dark-theme] .dshwp-root .dshwp-file-name{color:#f1f5f9!important;-webkit-text-fill-color:#f1f5f9!important;}body[data-ds-dark-theme] .dshwp-root .dshwp-toolbar-label,body[data-ds-dark-theme] .dshwp-root .dshwp-toggle,body[data-ds-dark-theme] .dshwp-root .dshwp-row label,body[data-ds-dark-theme] .dshwp-root .dshwp-val,body[data-ds-dark-theme] .dshwp-root .dshwp-note,body[data-ds-dark-theme] .dshwp-root .dshwp-file-size,body[data-ds-dark-theme] .dshwp-root .dshwp-preview,body[data-ds-dark-theme] .dshwp-root .dshwp-file-thumb-empty{color:#cbd5e1!important;-webkit-text-fill-color:#cbd5e1!important;}body[data-ds-dark-theme] .dshwp-root .dshwp-color-code{color:#f1f5f9!important;-webkit-text-fill-color:#f1f5f9!important;}",
    ...
    function apply(ctx) {
      ...
      function surfaceValues(pane) {
        ...
        var op = Math.max(0.25, Math.min(1, Number(pane.opacity) || 0.9));
      ...
      function buildTokens(pane) {
        ...
        for (var tokenName in SURFACE_TOKENS) {
          ...
          var alpha = token.kind === "base" ? Math.max(0.15, op - 0.25) : Math.min(1, op + 0.05);
          tokens[tokenName] = {
      ...
      function buildTextCss(c) {
        ...
        function addColor(scope, value) {
          ...
          css.push(scope + " header{" + values + ";color:" + value + "!important;}");
          css.push(scope + " header *{color:" + value + "!important;-webkit-text-fill-color:" + value + "!important;}");
        ...
        function addSidebarColor(scope, value) {
          ...
          css.push(scope + " :where(button,span,svg,input,textarea){color:" + value + "!important;-webkit-text-fill-color:" + value + "!important;}");
        }
        function sidebarScope(prefix) {
          return prefix + " .hHd-Xa_root," + prefix + " [data-slot=\"sidebar.workspaces\"]," + prefix + " [class*=\"_root\"]:has([data-slot=\"sidebar.workspaces\"])";
        }
        if (color) {
          addColor(mainWorkspace, color);
          addSidebarColor(sidebarScope("body:not(:has([data-trajectory-scroll]))"), color);
          if (c.textShadow) css.push(mainWorkspace + " [data-conversation-scroll]," + mainWorkspace + " header{text-shadow:0 1px 2px rgba(0,0,0,.55);}");
        } else {
          ...
          addSidebarColor(sidebarScope("body:not([data-ds-dark-theme]):not(:has([data-trajectory-scroll]))"), TEXT_COLORS.dark);
          addSidebarColor(sidebarScope("body[data-ds-dark-theme]:not(:has([data-trajectory-scroll]))"), TEXT_COLORS.light);
          if (c.textShadow) {
            css.push(lightMain + " header{text-shadow:0 1px 2px rgba(255,255,255,.6);}");
            css.push(darkMain + " header{text-shadow:0 1px 2px rgba(0,0,0,.6);}");
          }
        }
        return css.join("");
      }
      ...
      function buildTrajectorySchemeCss(c, trajectoryWorkspace, trajectoryRoot) {
        var scheme = c.trajectoryColorScheme || "native";
        var rootScope = trajectoryWorkspace + " " + trajectoryRoot;
        var controlColor = "var(--dsw-alias-label-primary)";
        var rules = [];
        if (scheme === "light" || scheme === "dark") {
          var utilitySurface = scheme === "dark" ? "rgba(15,20,29,.92)" : "rgba(255,255,255,.92)";
          var readabilityShadow = scheme === "dark" ? "0 1px 2px rgba(0,0,0,.82)" : "0 1px 1px rgba(255,255,255,.72)";
          rules.push(rootScope + "{" + declarations(trajectoryPalette(scheme)) + "text-shadow:" + readabilityShadow + ";}");
          rules.push(rootScope + " [role=tooltip]," + rootScope + " [class*=\"_requestBoundaryControl\"]::after," + rootScope + " > :first-child input{background:" + utilitySurface + "!important;}");
        } else {
          rules.push("body:not([data-ds-dark-theme]) " + rootScope + "{" + declarations(trajectoryPalette("nativeLight")) + "}");
          rules.push("body[data-ds-dark-theme] " + rootScope + "{" + declarations(trajectoryPalette("nativeDark")) + "}");
        }
      ...
      function buildCss(c, urls) {
        ...
        return [
          ...
          surfaceCss.join(""),
          trajectoryWorkspace + "{background:transparent!important;--dsw-alias-bg-base:transparent!important;}",
          buildTextCss(c),
      ...
      function WallpaperSection() {
        ...
        return h("div", { className: "dshwp-root" },
          ...
          h("section", { className: "dshwp-card" },
            ...
            pane === "main" ? rangeRow(t("opacity"), selected.opacity, 0.3, 1, 0.05, "", function (v) { commitPane({ opacity: v }); }) : null
          ),
          h("section", { className: "dshwp-card" },
            ...
            pane === "trajectory"
              ? h(React.Fragment, null,
                  h("div", { className: "dshwp-row" },
                    ...
                    h("div", { className: "dshwp-segment" },
                      [["native", "nativeScheme"], ["dark", "darkScheme"], ["light", "lightScheme"]].map(function (item) {
                        return h("button", {
                          key: item[0],
                          className: "dshwp-btn" + ((c.trajectoryColorScheme || "native") === item[0] ? " dshwp-active" : ""),
                          "aria-pressed": (c.trajectoryColorScheme || "native") === item[0],
                          onClick: function () { commit({ trajectoryColorScheme: item[0] }); }
                        }, t(item[1]));
                      })
                    )
                  ),
                  h("div", { className: "dshwp-note" }, t("trajectorySchemeNote"))
                )
              : h(React.Fragment, null,
                  h("div", { className: "dshwp-row" },
